...
class MovieDetailContent extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<MoviesDetailsBloc, MovieDetailStates>(
                    ...
                    background: FadeIn(
                      ...
                      child: ShaderMask(
                        ...
                        child: CachedNetworkImage(
                          ...
                          imageUrl:state.movieDetails!.backdropPath == null?'https://img.freepik.com/free-psd/film-strip-with-butter-popcorn_23-2148470110.jpg?w=900&t=st=1667220318~exp=1667220918~hmac=33bf260eb86f34cd097435f2f5117fe3ff89f1fd3d98644fdbfe7138238d4f13' :AppConstants.imageUrl(state.movieDetails!.backdropPath!),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
    ...
    return SliverGrid(
      delegate: SliverChildBuilderDelegate(
        (context, index) {
          ...
          return InkWell(
            onTap: (){
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) =>MovieDetailScreen(id: recommendation.id)));
            },
            child: FadeInUp(
              from: 20,
              duration: const Duration(milliseconds: 500),
              child: ClipRRect(
                ...
                child: CachedNetworkImage(
                  imageUrl:recommendation.backdropPath==null? 'https://img.freepik.com/free-psd/film-strip-with-butter-popcorn_23-2148470110.jpg?w=900&t=st=1667220318~exp=1667220918~hmac=33bf260eb86f34cd097435f2f5117fe3ff89f1fd3d98644fdbfe7138238d4f13': AppConstants.imageUrl(recommendation.backdropPath!),
